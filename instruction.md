...
Для отправки изменений в оригинальный репозиторий с которого был сделан fork надо на [github](https://github.com/) нажать *Compare & pull request*:

![](fullrequest_buttom.png)
